...
use Phauthentic\Specification\Examples\OpenItemAccountingGerman\Modelle\OffenerPostenstatus;

/**
 * Erfüllt, wenn ein OffenerPosten noch nicht ausgeglichen oder abgeschrieben wurde.
 */
class IstOffen extends AbstractSpecification
{
    public function isSatisfiedBy(mixed $candidate): bool
    {
        ...
        return $candidate->getStatus() === OffenerPostenstatus::Offen;
    }
}
