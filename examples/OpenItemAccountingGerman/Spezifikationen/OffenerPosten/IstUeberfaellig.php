...
/**
 * Erfüllt, wenn ein OffenerPosten zum Stichtag $stichtag um mehr als $karenztage Tage
 * überfällig ist.
 */
class IstUeberfaellig extends AbstractSpecification
{
    ...
    public function isSatisfiedBy(mixed $candidate): bool
    {
        ...
        return $candidate->tageUeberfaellig($this->stichtag) > $this->karenztage;
    }
}
